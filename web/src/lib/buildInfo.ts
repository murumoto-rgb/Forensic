 ...
 * `git rev-parse` in dev, `docs/builds.md` for the build number).
 *
...
const numberPrefix = __BUILD_NUMBER__ ? `#${__BUILD_NUMBER__} · ` : "";
...
export const buildInfo = {
  ...
  display: `${numberPrefix}${__BUILD_BRANCH__}@${__BUILD_SHA__} · ${__BUILD_TIME__}`,
} as const;
